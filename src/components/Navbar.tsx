...
const getItemDescription = (name: string): string => {
  const descriptions: Record<string, string> = {
    ...
    "Contact Us": "Get in touch with our Sasni campus",
    ...
    Blog: "Latest news, event highlights & campus articles",
    Newsletter: "Our official monthly school chronicles & letters",
  };
                ...
                {activeDropdown === link.name && link.hasDropdown && (
                  <motion.div
                    ...
                    className={cn(
                      ...
                      link.name === "Contact Us" || link.name === "News & Media"
                        ? "right-0"
                        : "left-0",
                    )}
                    style={{
