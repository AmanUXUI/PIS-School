...
const PrincipalsMessage: FC = () => {
  useSEO({
    ...
    canonical: "https://pavnaintlschool.com/principals-message",
  });
  return (
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 lg:items-stretch items-start">
            ...
            <div className="lg:col-span-7 flex flex-col gap-8">
              <div className="flex items-center justify-center md:justify-start gap-3 w-full max-w-sm">
              ...
              <h2 className="text-3xl text-center md:text-left sm:text-[42px] md:text-[42px] lg:text-[42px] font-serif font-bold text-brand-navy leading-tight md:leading-[50px] lg:leading-[50px] tracking-tight">
