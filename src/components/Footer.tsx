          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 mb-16 border-b border-white/10 pb-16">
            ...
            <div className="md:col-span-6 lg:col-span-2">
              <h4 className="font-bold mb-8 uppercase tracking-widest text-[11px] text-white flex items-center">
                <span className="w-2 h-2 bg-brand-orange rounded-full mr-3 shadow-glow animate-pulse"></span> The School
              </h4>
              <ul className="space-y-4 text-[13px]">
                ...
                <li>
                  <a href="#academic-team" className="text-gray-400 hover:text-brand-orange transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-orange scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Academic Team
                  </a>
                </li>
                <li>
                  <a href="#chairmans-message" className="text-gray-400 hover:text-brand-orange transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-orange scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Chairman's Message
                  </a>
                </li>
                <li>
                  <a href="#principals-message" className="text-gray-400 hover:text-brand-orange transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-orange scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Principal's Message
                  </a>
                </li>
            ...
            <div className="md:col-span-6 lg:col-span-2">
              <h4 className="font-bold mb-8 uppercase tracking-widest text-[11px] text-white flex items-center">
                <span className="w-2 h-2 bg-brand-sky rounded-full mr-3 shadow-[0_0_10px_rgba(0,183,221,0.5)] animate-pulse"></span> Academics
              </h4>
              <ul className="space-y-4 text-[13px]">
                <li>
                  <a href="#curriculum" className="text-gray-400 hover:text-brand-sky transition-all duration-300 flex items-center group">
                ...
                <li>
                  <a href="#early-years" className="text-gray-400 hover:text-brand-sky transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-sky scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Early Years (3 - 5 Years)
                  </a>
                </li>
                <li>
                  <a href="#primary" className="text-gray-400 hover:text-brand-sky transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-sky scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Primary (5 - 11 Years)
                  </a>
                </li>
                <li>
                  <a href="#lower-secondary" className="text-gray-400 hover:text-brand-sky transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-sky scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Lower Secondary (11 - 14 Years)
                  </a>
                </li>
                <li>
                  <a href="#upper-secondary" className="text-gray-400 hover:text-brand-sky transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-sky scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Upper Secondary (14 - 16 Years)
                  </a>
                </li>
                <li>
                  <a href="#advance-as-a-level" className="text-gray-400 hover:text-brand-sky transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-sky scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
            ...
            {/* Column 4: Experience & Admissions */}
            <div className="md:col-span-6 lg:col-span-2">
              <h4 className="font-bold mb-8 uppercase tracking-widest text-[11px] text-white flex items-center">
                <span className="w-2 h-2 bg-brand-yellow rounded-full mr-3 shadow-[0_0_10px_rgba(255,202,5,0.5)] animate-pulse"></span> Admissions
              </h4>
              <ul className="space-y-4 text-[13px]">
                <li>
                  <a href="#admissions" className="text-gray-400 hover:text-brand-yellow transition-all duration-300 flex items-center group">
                ...
                <li>
                  <a href="#boarding" className="text-gray-400 hover:text-brand-yellow transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-yellow scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Boarding Life
                  </a>
                </li>
                <li>
                  <a href="#campus-life" className="text-gray-400 hover:text-brand-yellow transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-yellow scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Campus Life
                  </a>
                </li>
                <li>
                  <a href="#careers" className="text-gray-400 hover:text-brand-yellow transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-yellow scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Careers
                  </a>
                </li>
                <li>
                  <a href="#enquire-now" className="text-gray-400 hover:text-brand-yellow transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-yellow scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Enquire Now
                  </a>
                </li>
                <li>
                  <a href="#lets-talk" className="text-gray-400 hover:text-brand-yellow transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-yellow scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Let's Talk
                  </a>
                </li>
                <li>
                  <a href="https://pavnaintlschool.campuscare.cloud/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-brand-yellow transition-all duration-300 flex items-center group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-yellow scale-0 group-hover:scale-100 transition-all duration-300 mr-0 group-hover:mr-2" />
                    Apply Online
                  </a>
                </li>
            ...
            <div className="md:col-span-6 lg:col-span-3">
              <h4 className="font-bold mb-8 uppercase tracking-widest text-[11px] text-white flex items-center">
                <span className="w-2 h-2 bg-brand-yellow rounded-full mr-3 shadow-[0_0_10px_rgba(255,202,5,0.5)]"></span> Social Media
              </h4>
              <p className="text-gray-400 mb-6 text-[13px] leading-relaxed">Connect with us on our official social media handles to see daily campus updates, student achievements, and life at Pavna.</p>
