...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      "Have you ever wondered what a day in the life of a student at Pavna International School, Aligarh, a Cambridge International School, looks like? In this blog, we will provide an inside look at the daily experiences of students at this prestigious institution, where academic excellence, a nurturing environment, and a diverse range of extracurricular activities come together to create a well-rounded educational experience.",
    category: "Campus Life",
    date: "June 10, 2025",
    readTime: "4 min read",
...
export const getPostContent = (post: BlogPost): string => {
  ...
  if (post.id === "post-5") {
    return (
      "Have you ever wondered what a day in the life of a student at Pavna International School, Aligarh, a Cambridge International School, looks like? In this blog, we will provide an inside look at the daily experiences of students at this prestigious institution, where academic excellence, a nurturing environment, and a diverse range of extracurricular activities come together to create a well-rounded educational experience. \n\n" +
      "Morning: Starting the Day with a Warm Welcome \n\n" +
      "The day begins with a warm welcome from teachers and staff as students arrive at the school. After a brief morning assembly, which often includes announcements, student presentations, or motivational talks, students head to their first class of the day. The supportive atmosphere at Pavna International School, Aligarh, ensures that students feel encouraged and motivated to start the day on a positive note.\n\n" +
      "Academic Sessions: Engaging, Interactive Learning  \n\n" +
      "During the academic sessions, students at Pavna International School, Aligarh, are immersed in a challenging and engaging Cambridge International Curriculum. Lessons are designed to promote critical thinking, problem-solving, and independent learning through interactive activities, group discussions, and hands-on projects. Teachers provide individualized attention and support, helping students overcome challenges and excel in their studies.\n\n" +
      "Lunchtime: socializing and refueling \n\n" +
      "Lunchtime at Pavna International School, Aligarh, is not just about refueling for the afternoon; it’s also an opportunity for students to socialize, relax, and have fun with their peers. The school’s spacious cafeteria offers a variety of nutritious and delicious meal options that cater to diverse dietary preferences. Students can also spend time in the school’s lush outdoor spaces, enjoying the fresh air and sunshine. \n\n" +
      "Afternoon: Extracurricular Activities and Clubs \n\n" +
      "The afternoon is dedicated to extracurricular activities and clubs, which play a crucial role in the holistic development of students at Pavna International School, Aligarh. From sports, arts, and music to technology, community service, and leadership opportunities, there is a wide range of activities for students to choose from based on their interests and passions. These activities not only help students develop new skills and talents but also foster teamwork, creativity, and perseverance.\n\n" +
      "Homeward Bound: Reflecting on a Fulfilling Day \n\n" +
      "As the school day comes to a close, students head home, often reflecting on the new knowledge, skills, and experiences they have gained. The supportive and nurturing environment at Pavna International School, Aligarh, encourages students to share their accomplishments and challenges with their family members, fostering a strong sense of community and collaboration. \n\n" +
      "In conclusion, a day in the life of a student at Pavna International School, Aligarh, is filled with academic excellence, a nurturing environment, and diverse extracurricular activities. This unique combination ensures that students receive a well-rounded education that prepares them for success in an increasingly interconnected and dynamic world. By offering a glimpse into the daily experiences of students at this prestigious institution, we hope to illustrate the many benefits of choosing Pavna International School for your child’s education. "
    );
  }
  if (post.id === "post-6") {
    return (
      ...
      "The Aligarh-based Pavna International School is committed to fostering a nurturing atmosphere where students can grow personally, feel a sense of community, and realize their best potential. The instructors and staff at the school put forth a lot of effort to provide each kid with their own attention and supervision, making sure that they all feel respected and capable of succeeding.\n\n" +
      "Emphasis on practical knowledge and experience\n\n" +
  ...
  if (post.id === "post-14") {
    return (
      ...
      "During the press conference for the Book Launch, the young students who were involved in creating these projects confidently answered questions from the press, impressing them with their creativity and commitment. Overall, the books written by these little authors were a true testament to their talent, creativity, and dedication to their craft. \n\n The students who were involved in the book project spoke confidently and proudly about their work, and the press was thoroughly impressed with their creativity. The books were written by the students themselves, and each one was a unique testament to their talent and passion.\n\n" +
      "The press was deeply impressed by the dedication and enthusiasm that the students had put into the projects. They also praised the school for its commitment to fostering creativity and innovation in its students.\n\n The Launch Pad event was a great way for the students to show off their skills and for the community to come together and celebrate their achievements. The event was a huge success, and everyone had a great time. The students were proud to showcase their work and were excited to explore new opportunities for learning.\n\n This event was a great opportunity for the school community to come together and celebrate the talents of the students. It was also a great opportunity for the students to explore new opportunities and gain valuable experience. The event was a huge success and the school is proud of the students and their hard work.\n\n" +
      "Want to Enroll or Enquire about Admissions or Fees? \n\n Share your details and our team will connect with you soon."
    );
  }
  if (post.id === "post-15") {
    return (
      ...
      "At the end of the event, the chairman, Mr. Swapnil Jain, appreciated the students for their hard work and effort. The event was a great success, and the students were able to gain a great deal of knowledge and experience in the process of building the racing car.\n\n With the support of the PIS team, the students will be able to create and design a racing car. The PIS team is proud to have been a part of this amazing event and looks forward to working with the students to help them achieve their dreams. The success of this event has shown that with the right guidance and support, students can build and design racing car, and experience the thrill of racing.\n\n" +
      "Want to Enroll or Enquire about Admissions or Fees? \n\n Share your details and our team will connect with you soon."
    );
  }
  if (post.id === "post-16") {
