  ...
  return (
    <div className="bg-[#FDFCFB] min-h-screen text-brand-black font-gill selection:bg-brand-orange/20 selection:text-brand-navy">
      ...
      <section id="upper-secondary-subjects" className="py-16 md:py-24 bg-[#FAF9F6] border-t border-b border-gray-100/85">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mb-16 text-center md:text-left mx-auto md:mx-0">
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-brand-navy mb-4 text-center md:text-left">
            ...
            {[
              {
                ...
                items: ["First Language-English", "Second Language-Hindi", "Foreign Language-French"]
              },
              {
