    ...
    <section id="about-pavna" className="bg-[#FDFCFB] py-16 md:py-24 px-4 sm:px-8 md:px-16 border-t border-b border-gray-200 font-gill overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 lg:items-center mb-16 md:mb-24">
          ...
          >
            <div className="flex flex-col items-center lg:items-start w-fit max-w-full mx-auto lg:mx-0">
              <div className="flex items-center justify-center lg:justify-start gap-3 mb-6 w-full">
                ...
                <span className="shrink-0 text-[11px] leading-[28px] tracking-[1.65px] uppercase font-bold text-brand-orange text-center lg:text-left">ABOUT PIS</span>
                <div className="w-12 h-[2px] bg-brand-orange shrink-0"></div>
              </div>
            ...
            <p className="text-neutral-600 text-[16px] sm:text-[18px] leading-[26px] sm:leading-[30px] font-medium mb-8 max-w-3xl text-center lg:text-left mx-auto lg:mx-0 tracking-wide">
              For nearly three decades, Pavna has been quietly shaping confident, compassionate young people who think independently, lead with empathy, and are prepared to flourish in a complex and interconnected world. As one of the most respected international curriculum schools in Uttar Pradesh, we combine academic rigour with the warmth and values of a close-knit community.
            </p>
