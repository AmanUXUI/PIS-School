          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              <div className="text-[15px] sm:text-[16px] leading-[26px] text-neutral-600 font-normal space-y-6">
                <p>
                  Pavna International School is a leading Cambridge Curriculum school in India, committed to academic excellence, holistic education, and future-ready learning. Guided by the Pathway School philosophy and Continuum School approach, we nurture confident, creative, and globally minded students through experiential learning and innovation. As an Apple Distinguished School, we integrate technology into engaging, student-centred classrooms. Our vehicle-free, eco-friendly campus features smart classrooms, innovation labs, sports and performing arts facilities, and premium residential hostels. With a strong focus on leadership, character development, and global perspectives, Pavna International School prepares students to thrive in higher education and succeed in an ever-evolving world.
                </p>
              </div>
            </div>
