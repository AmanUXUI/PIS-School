          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 lg:items-stretch items-start">
            ...
            <div className="lg:col-span-7 flex flex-col gap-8">
              <div className="flex flex-col items-start w-fit max-w-full">
                ...
                <h2 className="text-3xl sm:text-[42px] md:text-[42px] lg:text-[42px] font-serif font-bold text-brand-navy text-center md:text-left leading-tight md:leading-[50px] lg:leading-[50px] tracking-tight">
